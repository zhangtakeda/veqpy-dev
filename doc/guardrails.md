...
- 所有 runtime 输出保持纯英文.
- 重要边界改动后同步更新 `README.md` 与 `doc/` 治理文档.

## Must Not

- 不把这些规则只留在口头约定里.
- 不让 README, `doc/overview.md`, `doc/conventions.md`, `doc/guardrails.md` 互相矛盾.
...
- 代码风格和注释约束看 `doc/conventions.md`.
- 当前仓库入口总览看 `doc/overview.md`.
- 架构边界和治理约束看 `doc/guardrails.md`.
